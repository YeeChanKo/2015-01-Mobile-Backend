 ...
 * @details 스레드 풀을 생성하여 스레드를 미리 생성하여 속도를 절약하고 스레드가 동작하는 개수를 제한할 수 있다.
 * @author flashscope
 * @date 2014-05-11
 * @version 0.0.1
 */
public class ThreadPoolDispatcher implements Dispatcher {
	...
	static final String NUMTHREADS = "50";
	...
	/**
	 * @brief 연결 데이터 처리
	 * @details 스레드풀에서 만들어진 스레드들이 이 함수의 accept()의 블록을 물고 대기를 하고 있다. 접속이 들어오면 소켓을 생성후에 Demultiplexer가 일을 할수있도록 전달한다.
	 * @param serverSocket
	 * @param handleMap
	 */
