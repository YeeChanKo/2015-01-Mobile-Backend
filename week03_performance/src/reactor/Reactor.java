...
/**
 * @brief 리엑터 방식 서버 클래스
 * @details 리엑터 방식으로 구현된 서버 구동 클래스로 헤더와 핸들러를 관리하는 HandleMap과 ServerSocket을 관리한다. 이 클래스는 ThreadPer와 ThreadPool방식을 변경하여 적용 가능하다.
 * @author flashscope
 * @date 2014-05-11
 * @version 0.0.1
 */
public class Reactor {
	...
	/**
	 * @brief 리엑터 생성자
	 * @details 포트번호를 인자로 받아 서버 소켓을 생성하고 HandleMap을 하나 만들어 둔다.
	 * @param port
	 */
	...
	/**
	 * @brief 서버 실행
	 * @details Dispatcher를 ThreadPerDispatcher로 할지 ThreadPoolDispatcher로 할지에 따라 스레드 운용 정책을 정할 수 있다.
	 */
